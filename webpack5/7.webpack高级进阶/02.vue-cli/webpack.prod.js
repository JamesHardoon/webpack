        ...
        use: [
          /* config.module.rule('js').use('cache-loader') */
          {
            ...
            options: {
              ...
              cacheIdentifier: '8d095014'
            }
          },
          /* config.module.rule('js').use('thread-loader') */
          {
            // 跟开发环境的区别是 使用 多线程打包，性能更好，打包速度更快
